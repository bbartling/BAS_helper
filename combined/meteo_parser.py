...
class OpenWeatherOne:
    ...
    def __init__(self, units="imperial"):
        self.api_key, self.longitude, self.latitude = self.get_api_key_and_gps().values()
        self.complete_url = (
    ...
    @property
    def temp_8AM(self):
        return self.data['hourly'][2]['temp']

    @property
    def hum_8AM(self):
        return self.data['hourly'][2]["humidity"]

    @property
    def dewpoint_8AM(self):
        return self.data['hourly'][2]["dew_point"]

    @property
    def clouds_8AM(self):
        return self.data['hourly'][2]["clouds"]

    @property
    def desciption_8AM(self):
        return self.data['hourly'][2]['weather'][0]['description']
    ...
    @property
    def temp_5PM(self):
        return self.data['hourly'][11]['temp']
